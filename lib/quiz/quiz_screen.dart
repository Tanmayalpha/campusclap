...
import 'package:campusclap/quiz/quiz_submitted.dart';
...
class _QuizScreenState extends State<QuizScreen> {
        ...
        child: Scaffold(
         ...
         // appBar: customAppBar(context, widget.quiz!.course.toString()),
          appBar: PreferredSize(
              ...
              commonAppBar(context,text: widget.quiz!.course.toString()) ),
          body: LoadingOverlay(
  ...
  Future<void> _nextSubmit() async {
    if (_answers[_currentIndex] == null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            "You_must_select_an_answer_to_continue",
          ),
        ),
      );
      return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            "You_must_write_answer_to_continue",
          ),
        ),
      );
      return;
  ...
  Future<void> _submitQuiz() async {
   ...
   // log("Bearer " + authToken);
    var formDataMap = {
      "course_id": widget.quiz!.courseId.toString(),
      "topic_id": widget.quiz!.id.toString(),
    ...
    print("Submit Quiz API - $formDataMap");
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        Fluttertoast.showToast(
            msg: "Quiz_Submitted_Successfully",
        ...
        print('${response.data}_________________typ');
        print('${widget.quiz!.type}_________________typ');
        Navigator.pop(context);
        Fluttertoast.showToast(
            msg: "Quiz_Already_Submitted",
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.CENTER,
            backgroundColor: Colors.blue,
            textColor: Colors.white,
  ...
  Future<bool?> _onWillPop() async {
    return showDialog<bool>(
      ...
      builder: (_) {
        return AlertDialog(
          content: Text("Are_you_sure_you_want_to_quit_the_quiz"),
          title: Text("Warning_"),
          actions: <Widget>[
            TextButton(
              child: Text("Yes_"),
