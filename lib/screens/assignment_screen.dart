  ...
  void uploadAssignment(file, courseId, chapterId) async {
    ...
    if (response.statusCode == 200) {
      ...
      Fluttertoast.showToast(
          msg: "Assignment_submitted_successfully",
      ...
      Navigator.pop(context);
      Fluttertoast.showToast(
          msg: "Assignment_submission_failed",
          textColor: Colors.white,
    ...
    return SafeArea(
      child: Scaffold(
         appBar: PreferredSize(
             ...
             child: commonAppBar(context,text: 'Assignment') ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(hintText: "Enter_Title"),
                      validator: (value) {
                        if (value!.length == 0) {
                          return "Enter_Title";
                        } else {
                    ...
                    children: [
                      TextButton.icon(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: colors.textColor.withOpacity(0.09),
                        ),
                      ),
                      SizedBox(
                        width: 15.0,
                        ...
                        if (form.validate() == true) {
                          if (_mySelection != null) {
                            if (sFileName != null) {
                              ...
                              Fluttertoast.showToast(
                                  msg: "Choose_Assignment_file");
                            }
                          } else {
                            Fluttertoast.showToast(msg: "Select_Chapter");
                          }
                        } else {
                          return;
                        }
