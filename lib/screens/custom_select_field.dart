...
import 'package:flutter_custom_selector/utils/enum.dart';
import 'package:flutter_custom_selector/utils/flutter_custom_select_item.dart';
import 'package:flutter_custom_selector/utils/utils.dart';
import 'package:flutter_custom_selector/widget/flutter_custom_selector_sheet.dart';
...
class _CustomSingleSelectFieldState<T>
  ...
  Widget build(BuildContext context) {
   ...
   // print(selectedItem.toString() + 'hsdfhkf');

    widget.controller?.text = _selectedItemAsString(selectedItem);
