...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  requestAppointment(courseId, title, List<Appointment> appointment) async {
    ...
    if (res.statusCode == 200) {
      ...
      Fluttertoast.showToast(msg: "Request_Successfully");
      setState(() {
        requestController.text = '';
      });
      Navigator.pop(context);
    } else {
      Fluttertoast.showToast(msg: "Something_went_wrong");
      requestController.text = '';
    }
  }
  ...
  deleteAppointment(id) async {
    ...
    if (res.statusCode == 200) {
      Fluttertoast.showToast(
          msg: "Appointment_deleted_successfully",
  ...
  showAlertDialog(BuildContext context, courseId, appointment) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Request_Appointment"),
      content: Container(
        child: TextFormField(
          maxLines: 3,
          controller: requestController,
          decoration: InputDecoration(hintText: "Enter_request"),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    var appointment = contentModel != null
        ? contentModel!.appointment
        : [];
    return Scaffold(
     // appBar: customAppBar(context, translate("Appointment_")),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          showAlertDialog(
              context, widget.courseDetail?.course!.id, appointment);
        },
