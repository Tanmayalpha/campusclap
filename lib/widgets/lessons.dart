...
import 'package:campusclap/player/audio_player.dart';
import 'package:campusclap/player/downloader.dart';
import 'package:campusclap/player/playlist_screen.dart';
import 'package:campusclap/screens/pdf_viewer.dart';
import 'package:campusclap/screens/playlist.dart';
import 'package:campusclap/test/model_test.dart';
...
class _LessonsState extends State<Lessons> {
  ...
  List<Widget> _buildexpandablewidget(
    ...
    playVideo(idx) {
      ...
      bool isWatching = false/*Provider.of<WatchlistProvider>(context, listen: false)
          .isWatching(widget.details!.course!.id)*/;
      if (!isWatching) {
        print("object5");
