...
import 'package:campusclap/Models/zoom_meeting.dart';
import 'package:campusclap/commen/apidata.dart';
import 'package:campusclap/screens/more_screen.dart';
import 'package:campusclap/screens/pdf_viewer.dart';
import 'package:campusclap/utils/color.dart';
import 'package:campusclap/utils/globle.dart';
import 'package:campusclap/widgets/sliding_appbar.dart';
import 'package:campusclap/zoom/join_screen.dart';
...
class PlayListScreen extends StatefulWidget {
  PlayListScreen(
      ...
      this.markedSec,
      this.defaultIndex,
      this.courseDetails, this.isPaid})
      : super(key: key);
...
class _PlayListScreenState extends State<PlayListScreen>
  ...
  Future<RecievedProgress> updateProgress(List<String> checked) async {
    ...
    print('${ widget.sections![0].sectionDetails!.courseId}');
  ...
  Widget build(BuildContext context) {
    ...
    // T.Theme mode = Provider.of<T.Theme>(context);
    bool firstTime = checkPurchaedProgressStatus(
            "${widget.sections![0].sectionDetails!.courseId}");

    print('${firstTime}_________');
    return Scaffold(
      key: _scaffoldKey,
      backgroundColor: Colors.black,
        ...
        child: NestedScrollView(
          ...
          body: TabBarView(
            children: [
              ...
              MoreScreen(widget.courseDetails,isPaid: widget.isPaid),
            ],
          ),
        ),
      ),
  ...
  Future<void> initPurchasedCourses(BuildContext context) async {
    ...
    if (res.statusCode == 200) {
      MyCoursesModel  myCoursesModel = MyCoursesModel.fromJson(json.decode(res.body));
