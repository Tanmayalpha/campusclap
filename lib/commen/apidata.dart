class APIData {
  ...
  static const String applyJob = domainApiLink + "apply_job?secret=";
  static const String jobDetail = domainApiLink + "viewjob/";
  static const String getJob = domainApiLink + "list/job?secret=";
  static const String termsCondition = domainApiLink + "terms_policy?secret=";
  static const String appliedJob = domainApiLink + "view/applyjoblist?secret=";
  ...
  static const String getState = domainApiLink + "get_states?secret=";
  static const String getCity = domainApiLink + "get_cities?state_id=";
  ...
  static const String getSlotes = domainApiLink + "get_slotes?secret=";
  static const String bookSlot = domainApiLink + "book_assessment_slotes?secret=";
  ...
  static const String checkCertificate = domainApiLink + "check_certificate/";
  static const String startCourse = domainApiLink + "start_course/";
  static const String getCertificate = domainApiLink + "get_certificate_list?secret=";
  ...
  static const String certificate = domainApiLink + 'certificate/';
 ...
 // static const String secretKey = "90efc0b2-8058-47f7-9469-9a25c94382c7";
